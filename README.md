...
1. Average Grade Point by Faculty

Shows the academic performance trends for each faculty, highlighting top- and low-performing areas.

2. Total Students by Grade Category

Pie chart categorizing students performance into:
...
3. Average Grade Point by Academic Year

Line chart tracking performance trends from 2020–2024.

4. Total Students by Faculty

Distribution of students across faculties, supporting departmental capacity planning.

5. Total Students by Enrollment Year

Shows the stability of student intake across years.

6. Total Students by Gender

Balanced gender representation.

7. Tuition Fee by Fee Status

Pie chart showing proportion of “Paid” vs “Due” fees.

8. Total Revenue Generated by Course

Top 10 revenue-generating courses—critical for financial planning.

9. Grade Point vs Attendance Rate

Scatterplot revealing a strong positive correlation.

10. Total Students by Nationality

Breakdown of students by country.

11. Students and Grade Point by Scholarship Status

Bar + line combo chart showing academic performance relative to scholarship award.
